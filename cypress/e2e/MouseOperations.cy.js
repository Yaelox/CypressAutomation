...
describe('Mouse', () => { 
    ...
    it('Mouse Hover',()=>{
        ...
        cy.visit('https://opencart.abstracta.us/')
         ...
         cy.get("body > div:nth-child(3) > nav:nth-child(1) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(1) > div:nth-child(2) > div:nth-child(1) > ul:nth-child(1) > li:nth-child(2) > a:nth-child(1)")
